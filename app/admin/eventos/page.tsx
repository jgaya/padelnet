...
import { deleteEvento, listEventosForAdmin, type EventoListItem } from "@/actions/eventos";
...
export default function AdminEventosPage() {
  ...
  const fetchEventos = useCallback(async () => {
    try {
      ...
      const data = await listEventosForAdmin(opts);
  ...
  return (
    <div className="container padel-complejos-list">
      <TitleBar title="Eventos accesibles" backURL="/admin/complejos" total={total} />
            ...
            renderHeader={() => (
              <tr>
                ...
                <th onClick={() => handleSort("tipo")} style={{ cursor: "pointer" }}>
                  Tipo
                  <SortArrow field="tipo" orderBy={orderBy} orderDir={orderDir} />
                </th>
                ...
                <th onClick={() => handleSort("fin")} style={{ cursor: "pointer" }}>
                  Fin
                  <SortArrow field="fin" orderBy={orderBy} orderDir={orderDir} />
                </th>
                <th>Abierto</th>
                <th>Visible</th>
                <th>Finalizado</th>
            ...
            renderRow={(evento) => (
              <tr key={evento.id}>
                ...
                <td className="d-flex gap-2 padel-table-actions">
                  ...
                  <Link
                    href={`/admin/complejos/${evento.complejoId}/eventos/${evento.id}/torneos`}
