  ...
  return (
    <div className="container padel-complejos-list">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link
          href={`/superadmin/complejos/${complejoId}/eventos/${eventoId}/torneos/${torneoId}/zonas`}
            ...
            <div className="card-body">
              ...
              <div className="d-flex flex-wrap gap-2">
                {data.canchas.map((cancha) => {
                  ...
                  return (
                    <label key={cancha.id} className="btn btn-outline-secondary" style={{ cursor: "pointer" }}>
                      <input
                        type="checkbox"
                        className="me-2"
                        checked={selected}
