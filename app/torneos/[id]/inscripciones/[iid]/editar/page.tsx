          ...
          {data.status === "NOT_ALLOWED" ? (
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 rounded-2xl border border-energy-orange/25 bg-energy-orange/5 px-4 py-4">
                <h2 className="text-sm font-semibold text-deep-black">
                ...
                {data.torneo.inscripcionesAbiertas ? (
                  <>
                    ...
                    <form action={submitBaja} className="mt-3">
                      ...
                      <button
                        type="submit"
                        className="rounded-full border border-energy-orange bg-white px-5 py-2.5 text-sm font-semibold text-energy-orange transition hover:bg-energy-orange hover:text-white"
                      >
                        Darme de baja
                      </button>
                    </form>
