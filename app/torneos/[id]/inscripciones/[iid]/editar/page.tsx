            ...
            <div className="overflow-hidden rounded-3xl border border-deep-black/10 bg-white shadow-sm">
                ...
                <div className="space-y-4 px-5 py-5 sm:px-7 sm:py-7">
                    <div className="rounded-2xl border border-deep-black/10 bg-surface-soft px-4 py-3 text-sm text-deep-black/80">
                        Jugador 1: <span className="font-semibold text-deep-black">{data.currentUser.name} {data.currentUser.lastname}</span> ({generoLabel(data.currentUser.genero)} - Categoria {data.currentUser.categoria ?? "N/D"})
                    </div>
                    ...
                    {data.status === "NOT_ALLOWED" ? (
                        ...
                        <div className="space-y-4">
                            <div className="rounded-2xl border border-deep-black/10 bg-white px-4 py-3 text-sm text-deep-black/80">
                                Pareja actual: <span className="font-semibold text-deep-black">{data.currentPartner.name} {data.currentPartner.lastname}</span> ({generoLabel(data.currentPartner.genero)} - Categoria {data.currentPartner.categoria ?? "N/D"})
                            </div>
                            ...
                            <form action={submitEdit} className="space-y-4">
                                                        ...
                                                        >
                                                            <td className="px-3 py-2">
                                                                <input
                                                                    ...
                                                                    name="partnerId"
                                                                    value={candidate.id}
                                                                    defaultChecked={candidate.id === data.currentPartner.id}
                                                                    required
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-2">
                                    <p className="text-sm text-deep-black/70">
                                        Candidatos disponibles: <span className="font-semibold text-deep-black">{data.candidates.length}</span>
                                    </p>
                                    <button
                                        type="submit"
